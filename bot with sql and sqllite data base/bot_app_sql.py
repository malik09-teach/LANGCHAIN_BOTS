...
st.set_page_config(page_title="langchain:chat with database sql DB",page_icon=🦜)
st.title("langchain:chat with database sql DB")
...
select_opt=st.sidebar.radio(label="chose DB type ",options=RADIO_OPT)
